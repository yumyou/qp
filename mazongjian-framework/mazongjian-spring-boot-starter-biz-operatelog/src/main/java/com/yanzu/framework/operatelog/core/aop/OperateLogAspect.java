package com.yanzu.framework.operatelog.core.aop;
...
import com.yanzu.framework.common.util.monitor.TracerUtils;
import com.yanzu.framework.common.util.servlet.ServletUtils;
import com.yanzu.framework.operatelog.core.enums.OperateTypeEnum;
import com.yanzu.framework.operatelog.core.service.OperateLog;
...
import static com.yanzu.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.yanzu.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.yanzu.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.yanzu.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.yanzu.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.yanzu.framework.operatelog.core.annotations.OperateLog operateLog,
