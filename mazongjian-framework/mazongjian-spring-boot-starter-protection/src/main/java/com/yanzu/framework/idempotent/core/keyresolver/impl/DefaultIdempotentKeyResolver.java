package com.yanzu.framework.idempotent.core.keyresolver.impl;
...
public class DefaultIdempotentKeyResolver implements IdempotentKeyResolver {
    ...
    public String resolver(JoinPoint joinPoint, Idempotent idempotent) {
        ...
        String loginUserId = "";
        try {
            loginUserId = String.valueOf(getLoginUserId());
        } catch (Exception e) {
//            e.printStackTrace();
        }
        return SecureUtil.md5(loginUserId + methodName + argsStr);
    }
