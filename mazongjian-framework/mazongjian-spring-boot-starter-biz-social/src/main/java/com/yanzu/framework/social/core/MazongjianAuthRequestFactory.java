package com.yanzu.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import com.yanzu.framework.social.core.enums.AuthExtendSource;
import com.yanzu.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 * @date 2021-10-31
 */
public class MazongjianAuthRequestFactory extends AuthRequestFactory {
    ...
    public MazongjianAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
