package com.yanzu.module.infra.controller.admin.logger.vo.apierrorlog;

import com.yanzu.framework.excel.core.annotations.DictFormat;
import com.yanzu.framework.excel.core.convert.DictConvert;
import com.yanzu.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogExcelVO {
    ...
    @DictFormat(com.yanzu.module.system.enums.DictTypeConstants.USER_TYPE)
