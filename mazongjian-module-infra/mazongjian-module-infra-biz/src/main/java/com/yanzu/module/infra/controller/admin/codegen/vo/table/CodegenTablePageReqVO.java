package com.yanzu.module.infra.controller.admin.codegen.vo.table;
...
public class CodegenTablePageReqVO extends PageParam {
    ...
    @Schema(description = "表名称，模糊匹配", example = "mazongjian")
    private String tableName;

    @Schema(description = "表描述，模糊匹配", example = "芋道")
    private String tableComment;

    @Schema(description = "实体，模糊匹配", example = "Mazongjian")
