package com.yanzu.module.infra.service.codegen.inner;
...
import com.yanzu.framework.common.util.object.ObjectUtils;
...
import com.yanzu.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "mazongjian-module-${table.moduleName}/" + // 顶级模块
                "mazongjian-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "mazongjian-module-${table.moduleName}/" + // 顶级模块
                "mazongjian-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "mazongjian-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "mazongjian-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
