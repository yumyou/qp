package com.yanzu.module.system.service.social;
...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    @Resource// 由于自定义了 MazongjianAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private MazongjianAuthRequestFactory mazongjianAuthRequestFactory;
