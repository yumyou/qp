package com.yanzu.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelBaseVO {
    ...
    @Schema(description = "短信 API 的账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "mazongjian")
